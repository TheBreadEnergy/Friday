...
IFontDisp = Font
__all__ = [ 'OLE_OPTEXCLUSIVE', 'FONTNAME', 'FONTSTRIKETHROUGH',
           'OLE_YSIZE_CONTAINER', 'Default', 'IFont',
           'OLE_YSIZE_PIXELS', 'Checked', 'IFontEventsDisp',
           'OLE_CANCELBOOL', 'OLE_YPOS_CONTAINER', 'FontEvents',
           'IPictureDisp', 'OLE_YPOS_HIMETRIC', 'OLE_XPOS_HIMETRIC',
           'OLE_XSIZE_PIXELS', 'StdFont', 'OLE_ENABLEDEFAULTBOOL',
           'FONTSIZE', 'OLE_HANDLE', 'OLE_XSIZE_CONTAINER',
           'IFontDisp', 'OLE_COLOR', 'OLE_YPOS_PIXELS',
           'LoadPictureConstants', 'IPicture', 'VgaColor',
           'FONTUNDERSCORE', 'Font', 'OLE_YSIZE_HIMETRIC',
           'OLE_XSIZE_HIMETRIC', 'StdPicture', 'Monochrome',
           'Unchecked', 'Color', 'OLE_XPOS_PIXELS', 'Picture',
